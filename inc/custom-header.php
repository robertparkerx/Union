 ...
 *
 * @uses union_header_style()
 */
function union_custom_header_setup() {
...
if ( ! function_exists( 'union_header_style' ) ) :
/**
 * Styles the header image and text displayed on the blog.
 *
 * @see union_custom_header_setup().
 */
function union_header_style() {
