<?php
    ...
    $args = array(
        ...
        'menu_title'           => __( 'Union Options', 'redux-framework-demo' ),
        'page_title'           => __( 'Union Options', 'redux-framework-demo' ),
    ...
    Redux::setSection( $opt_name, array(
        'title'      => __( 'Default', 'redux-framework-demo' ),
        'id'         => 'default-typo-subsection',
        'subsection' => true,
        'fields'     => array(
            array(
                'id'       => 'typo-body',
